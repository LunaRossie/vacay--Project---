    ...
    <div className="card bg-white card-rounded w-50">
      ...
      {loading ? (
        ...
        <div className="card-body text-center mt-3">
          <h2>
            {adoption[0].tech1} vs. {adoption[0].tech2}
          </h2>
          <h3>
            {adoption[0].tech1_votes} : {adoption[0].tech2_votes}
          </h3>
          <button className="btn btn-info" onClick={() => handleVote(1)}>
            Vote for {adoption[0].tech1}
          </button>{' '}
          <button className="btn btn-info" onClick={() => handleVote(2)}>
            Vote for {adoption[0].tech2}
          </button>
